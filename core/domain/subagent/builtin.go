	...
	return []Definition{
		{
			...
			AllowedTools:   []string{"list_files", "read_file", "search_files", "read_asset", "knowledge_search", "spawn_agent", "send_message", "followup_task", "list_agents", "wait_agent", "interrupt_agent"},
		...
		},
		{
			...
			AllowedTools:   []string{"list_files", "read_file", "search_files", "spawn_agent", "send_message", "followup_task", "list_agents", "wait_agent", "interrupt_agent"},
			CapabilityMode: CapabilityModeReadOnly, IsolationMode: domainworkspace.IsolationModeDirect,
		...
		},
		{
			...
			AllowedTools:   []string{"list_files", "read_file", "search_files", "read_asset", "knowledge_search", "edit_file", "write_file", "shell", "spawn_agent", "send_message", "followup_task", "list_agents", "wait_agent", "interrupt_agent"},
