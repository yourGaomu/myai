...
func (s *Server) handleAgentMessage(p *peer, remoteAddr string, message protocol.Message, agentUserID *string, agentDeviceID *string) error {
	...
	case protocol.TypeAssistantDelta, protocol.TypeAssistantDone, protocol.TypeToolCall, protocol.TypePermissionAsk, protocol.TypeError:
...
func (s *Server) handleClientMessage(p *peer, remoteAddr string, message protocol.Message) error {
	switch message.Type {
	case protocol.TypeUserMessage, protocol.TypePermissionResult:
...
func (s *Server) forwardToClient(message protocol.Message) error {
	...
	if message.Type == protocol.TypeAssistantDone || message.Type == protocol.TypeError {
